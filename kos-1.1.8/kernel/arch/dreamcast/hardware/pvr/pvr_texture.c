...
CVSID("pvr_texture.c,v 1.1.1.1 2002/10/09 13:59:14 tekezo Exp");
...
void pvr_txr_load_ex(void * src, pvr_ptr_t dst, uint32 w, uint32 h, uint32 flags) {
	...
	assert_msg( !(flags & PVR_TXRLOAD_VQ), "VQ compression on the fly not supported yet" );
